...
import ai.abstraction.ZhichaoCounterBack;
...
//        AI ai1 = new RandomAI();
        AI ai1 = new ZhichaoCounterBack(UnitTypeTable.utt, new AStarPathFinding());
        AI ai2 = new LightRush(UnitTypeTable.utt, new AStarPathFinding());
//        AI ai1 = new WorkerRush(UnitTypeTable.utt, new AStarPathFinding());
//        AI ai2 = new RangedRush(UnitTypeTable.utt, new GreedyPathFinding());
